...
// HACK export via window so its available to other code
window.ms_keywords = (
...
window.ms_builtinConstants = (
	"true|false|Jan|January|Feb|February|Mar|March|April|Apr|May|June|Jun|July|Jul|August|Aug|September|Sep|October|Oct|November|Nov|December|Dec"
);
window.ms_builtinFunctions = (
	"N|min|max|average"
);
...
ace.define("ace/mode/python_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (require, exports, module) {
	...
	var PythonHighlightRules = function () {
		...
		var keywords = ms_keywords;

		var builtinConstants = ms_builtinConstants;

		var builtinFunctions = ms_builtinFunctions;
		...
		this.$rules = {
			...
			{
				token: "string",	// css/yaml - just one style for now
				regex: "\{.*\}$"
			},
			{
			...
			"constants": [
				{
					token: "constant.language", // year (not working yet)
					regex: "20\\d\\d\\b"
				},
				{
